...
public class Customer {
    ...
    private Set<CreatedOrder> createdOrders = new HashSet<CreatedOrder>();
	...
	public String toString() {
		return "Registered Customer is :- [id=" + id + ", name=" + name + ", balance=" + balance + ", createdOrders=" + createdOrders
				+ "]";
	}    
